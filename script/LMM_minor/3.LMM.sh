...
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/LMM_minor/output
...
#copy sparce GRM
cp  "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/grm/sp_grm* ./
...
--qcovar "$covarcFile" \
--covar "$covarbFile" \
--out ./output/geno_assoc_LMM_minor
...
#ls -lha >> ukb_gcta_LMM_minor.log

##Copying the output to your home folder
cp ./*.log    "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/assoc
cp ./output/* "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/assoc
