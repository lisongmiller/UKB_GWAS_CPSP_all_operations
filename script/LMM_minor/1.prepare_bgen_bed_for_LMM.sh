...
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/chr"$chromo"
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/bgen
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/bgen_temp
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/bed
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/output

##Going into the folder to run the analyse
cd /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/chr"$chromo"
tempFolder=/gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/bgen_temp



##Copying the pheno, covar and sample files.
cp $phenoFileFull ./
cp "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/input/LMM_minor/control_eid_norel.txt ./
...
##Running plink2, export bgen and bed
./plink2 --bgen "$tempFolder"/temp_ukb_imp_pf_chr"$chromo".bgen ref-first \
--sample "$tempFolder"/temp_ukb_imp_pf_chr"$chromo".sample \
--geno 0.05 \
--mind 0.1 \
...
cd /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/input/bgen
