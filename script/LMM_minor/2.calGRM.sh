...
#for part in {1..10}; do sbatch 2.calGRM.sh $part; done
...
mkdir -p /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/mkGRM

##Going into the TMPDIR to run the analyse
cd /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/mkGRM
...
##For this step 128 core 20 hours needed
##################
<<com
part=$1
cd /gpfs/scratch1/shared/songli/CPSP_allop/LMM_minor/mkGRM
./gcta64 --mbgen bgen.txt --sample ukb_imp_pf_chr1.sample --make-grm-part 10 "$part" --threads 124 --out full_dense_grm 
com
##################
...
cp ./*.log "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/grm
cp ./sp_grm* "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/grm
cp ./full_dense_grm.grm* "$HOME"/project/phd_project_ukb/UKB_Application64102/CPSP_allop/output/LMM_minor/grm
