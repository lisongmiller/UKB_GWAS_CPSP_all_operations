...
os.chdir('/home/miller/PhD_project/UKB_CPSP_allop/input/4.phenotype_file/gwas_phenotype_file/minor')
...
cpsp_pheno_final = pd.read_csv('/home/miller/PhD_project/UKB_CPSP_allop/input/4.phenotype_file/CPSP_phenotype/minor/cpsp_phenotype_minor.txt.gz',sep='\t',dtype=str)
...
cpsp_pheno_covarcheck.to_csv('/home/miller/PhD_project/UKB_CPSP_allop/input/4.phenotype_file/check_covar/minor/cpsp_pheno_covarcheck.txt',header = True, index = False, sep = '\t')
